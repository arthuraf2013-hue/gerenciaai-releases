...
contextBridge.exposeInMainWorld('pdv', {
  ...
  pairing: {
    gerarCodigo: invoke('pairing:gerarCodigo'),
    ...
    excluirDispositivo: invoke('pairing:excluirDispositivo'),
  },
  io: {
  ...
  backup: {
    ...
    abrirCriacaoContaGoogle: invoke('backup:abrirCriacaoContaGoogle'),
    salvarContaGoogle: invoke('backup:salvarContaGoogle'),
  },
  supply: {
