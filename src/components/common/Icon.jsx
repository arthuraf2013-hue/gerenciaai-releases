...
const SOFT = 0.5; // opacidade da parte "de fundo" dos ícones pictóricos
const RING = 0.24; // opacidade do círculo de fundo dos ícones de traço/glifo
const LINE = { stroke: 'currentColor', strokeWidth: 2.2, strokeLinecap: 'round', strokeLinejoin: 'round', fill: 'none' };
...
const ICONS = {
  ...
  restore: (
    <>
      ...
      <path d="M12 12.2v3.2" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" opacity={SOFT + 0.2} />
    </>
  ),
  ...
  edit: (
    <>
      ...
      <path d="M8.5 15.5L8 17.7l2.2-.5L18.4 9a1.4 1.4 0 0 0 0-2l-.9-.9a1.4 1.4 0 0 0-2 0z" {...LINE} strokeWidth="2" />
    </>
  ),
  signature: (
    <>
  ...
  briefcase: (
    <>
      ...
      <path d="M3.5 13h17" stroke="currentColor" strokeWidth="2.3" />
    </>
  ),
  ...
  save: (
    <>
      ...
      <rect x="7.3" y="13" width="9.4" height="6.7" rx="1" fill="none" stroke="currentColor" strokeWidth="2.1" />
    </>
  ),
  folder: (
    <>
      ...
      <path d="M3.5 10.2h17" stroke="currentColor" strokeWidth="2.1" opacity={SOFT + 0.35} />
    </>
  ),
  archive: (
    <>
      <rect x="3.5" y="4" width="17" height="5.4" rx="1.2" fill="currentColor" opacity={SOFT} />
      <rect x="4.3" y="10.2" width="15.4" height="9.8" rx="1" fill="none" stroke="currentColor" strokeWidth="2.1" />
  ...
  document: (
    <>
      ...
      <path d="M13.5 3.5v4h4" fill="none" stroke="currentColor" strokeWidth="2.1" />
      <path d="M9 13h6M9 16.3h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </>
  ),
  clipboard: (
    <>
      ...
      <path d="M8.5 12h7M8.5 15.5h7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </>
  ),
  duplicate: (
    <>
      <rect x="8" y="8" width="11" height="12.5" rx="1.6" fill="currentColor" opacity={SOFT} />
      <rect x="5" y="3.5" width="11" height="12.5" rx="1.6" fill="none" stroke="currentColor" strokeWidth="2.1" />
    </>
  ),
  trash: (
    <>
      <path d="M6.3 8.5h11.4l-1 11.2a2 2 0 0 1-2 1.8h-5.4a2 2 0 0 1-2-1.8l-1-11.2z" fill="currentColor" opacity={SOFT} />
      <path d="M4 8.5h16M9.5 8.5V6a1.5 1.5 0 0 1 1.5-1.5h2A1.5 1.5 0 0 1 14.5 6v2.5" fill="none" stroke="currentColor" strokeWidth="2.1" />
      <path d="M10 11.7v6M14 11.7v6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </>
  ),
  book: (
    <>
      <path d="M12 5.2c-1.7-1-4.4-1.3-6.7-.9v13.4c2.3-.4 5 0 6.7.9V5.2z" fill="currentColor" opacity={SOFT} />
      <path d="M12 5.2c1.7-1 4.4-1.3 6.7-.9v13.4c-2.3-.4-5 0-6.7.9V5.2z" fill="none" stroke="currentColor" strokeWidth="2.1" />
    </>
  ),
  history: (
    <>
      <path d="M6 4.5h11a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H8.5A2.5 2.5 0 0 1 6 17V4.5z" fill="currentColor" opacity={SOFT} />
      <path d="M6 4.5a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2" fill="none" stroke="currentColor" strokeWidth="2.1" />
      <path d="M9 9h6M9 12.3h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </>
  ),
  calendar: (
    <>
      <rect x="4" y="5.5" width="16" height="14.5" rx="1.8" fill="currentColor" opacity={SOFT} />
      <path d="M4 9.5h16" stroke="currentColor" strokeWidth="2.1" />
  ...
  wrench: (
    <>
      ...
      <path d="M14.7 6.3a3.6 3.6 0 0 0-4.8 4.4L5 15.6l2 2 4.9-4.9a3.6 3.6 0 0 0 4.4-4.8l-2.2 2.2-2-.6-.6-2 2.2-2.2z" fill="none" stroke="currentColor" strokeWidth="1.8" />
    </>
  ),
  lab: (
    <>
      ...
      <path d="M8.3 14.5h7.4" stroke="currentColor" strokeWidth="2.1" opacity={SOFT + 0.35} />
    </>
  ),
  search: (
    <>
      <circle cx="11" cy="11" r="6" fill="currentColor" opacity={SOFT} />
      <circle cx="11" cy="11" r="6" fill="none" stroke="currentColor" strokeWidth="2.3" />
  ...
  sliders: (
    <>
      <Ring />
      <path d="M6 8h12M6 16h12" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" />
  ...
  settings: (
    <>
      ...
      <path d="M12 5.7v1.8M12 16.5v1.8M18.3 12h-1.8M7.5 12H5.7M16.4 7.6l-1.3 1.3M8.9 15.1l-1.3 1.3M16.4 16.4l-1.3-1.3M8.9 8.9L7.6 7.6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </>
  ),
  palette: (
    <>
  ...
  graduation: (
    <>
      ...
      <path d="M6 11.4v3.7c0 1.4 2.7 2.6 6 2.6s6-1.2 6-2.6v-3.7" fill="none" stroke="currentColor" strokeWidth="2" />
  ...
  cake: (
    <>
      ...
      <path d="M4 15.5c1.4 1 2.6 1 4 0s2.6-1 4 0 2.6 1 4 0 2.6-1 4 0" fill="none" stroke="currentColor" strokeWidth="1.8" />
  ...
  money: (
    <>
      ...
      <circle cx="12" cy="12.3" r="2.6" fill="none" stroke="currentColor" strokeWidth="2" />
    </>
  ),
  cash: (
    <>
      ...
      <path d="M5.5 9v6M18.5 9v6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </>
  ),
  card: (
    <>
  ...
  receipt: (
    <>
      ...
      <path d="M8.5 8h7M8.5 11.3h7M8.5 14.6h4.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </>
  ),
  ...
  chat: (
    <>
      ...
      <path d="M7 9.5h10M7 12.5h6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </>
  ),
  mail: (
    <>
      <rect x="3" y="5.5" width="18" height="13" rx="1.8" fill="currentColor" opacity={SOFT} />
      <path d="M3.6 6.3L12 13l8.4-6.7" fill="none" stroke="currentColor" strokeWidth="2.1" />
    </>
  ),
  hourglass: (
    <>
      <Ring />
      <path d="M8 5.5h8M8 18.5h8" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" />
      <path d="M8.5 5.5v2.3c0 1.6 1 2.9 3.5 4.2 2.5-1.3 3.5-2.6 3.5-4.2V5.5" fill="currentColor" opacity={SOFT + 0.2} />
      <path d="M8.5 18.5v-2.3c0-1.6 1-2.9 3.5-4.2 2.5 1.3 3.5 2.6 3.5 4.2v2.3" fill="none" stroke="currentColor" strokeWidth="2" />
    </>
  ),
  globe: (
    <>
      <circle cx="12" cy="12" r="9" fill="currentColor" opacity={SOFT} />
      <path d="M3 12h18M12 3c2.5 2.5 3.8 5.6 3.8 9s-1.3 6.5-3.8 9c-2.5-2.5-3.8-5.6-3.8-9S9.5 5.5 12 3z" fill="none" stroke="currentColor" strokeWidth="1.8" />
    </>
  ),
  ...
  box: (
    <>
      ...
      <path d="M4 7.5L12 11.7l8-4.2M12 11.7v9" fill="none" stroke="currentColor" strokeWidth="2" />
    </>
  ),
  ingredient: (
    <>
      ...
      <path d="M6 13h12" stroke="currentColor" strokeWidth="1.8" opacity={SOFT + 0.35} />
    </>
  ),
  tag: (
    <>
  ...
  export: <><Ring /><path d="M8 12h8M12.5 8l3.5 4-3.5 4" {...LINE} /><path d="M6 6v12" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" opacity={SOFT + 0.2} /></>,
  import: <><Ring /><path d="M16 12H8M11.5 8L8 12l3.5 4" {...LINE} /><path d="M18 6v12" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" opacity={SOFT + 0.2} /></>,
  trendUp: (
    <>
      <Ring />
  ...
  chart: (
    <>
      <Ring />
      <path d="M6 18V11M12 18V6M18 18v-8" stroke="currentColor" strokeWidth="2.9" strokeLinecap="round" opacity={SOFT + 0.45} />
      <path d="M6 18V13M12 18V9M18 18v-5" stroke="currentColor" strokeWidth="2.9" strokeLinecap="round" />
    </>
  ),
  map: (
    <>
      <path d="M9 4.5L4 6.3v13.2l5-1.8 6 1.8 5-1.8V4.5l-5 1.8-6-1.8z" fill="currentColor" opacity={SOFT} />
      <path d="M9 4.5v13.2M15 6.3v13.2" fill="none" stroke="currentColor" strokeWidth="1.7" strokeDasharray="2.3 2.3" />
    </>
  ),
  home: (
    <>
  ...
  store: (
    <>
      ...
      <path d="M5.5 11v9h13v-9" fill="none" stroke="currentColor" strokeWidth="2" />
  ...
  truck: (
    <>
      ...
      <circle cx="7" cy="18" r="1.8" fill="none" stroke="currentColor" strokeWidth="2" />
      <circle cx="16.5" cy="18" r="1.8" fill="none" stroke="currentColor" strokeWidth="2" />
    </>
  ),
  car: (
    <>
      <path d="M4.5 15.5v-3l2-4.2a2 2 0 0 1 1.8-1.1h7.4a2 2 0 0 1 1.8 1.1l2 4.2v3z" fill="currentColor" opacity={SOFT} />
      <path d="M4.5 15.5v-3l2-4.2a2 2 0 0 1 1.8-1.1h7.4a2 2 0 0 1 1.8 1.1l2 4.2v3" fill="none" stroke="currentColor" strokeWidth="1.8" />
  ...
  scooter: (
    <>
      ...
      <circle cx="5.3" cy="16.7" r="2.1" fill="none" stroke="currentColor" strokeWidth="1.8" />
      <circle cx="17.5" cy="16.7" r="2.1" fill="none" stroke="currentColor" strokeWidth="1.8" />
      <path d="M5.3 16.7h6.5l1.7-6.2h3.2M8.5 10.5h4.2M17.5 16.7a3 3 0 0 0-3-3h-1" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M13 6.5h2.5l1 2.3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" opacity={SOFT + 0.3} />
    </>
  ),
  ...
  robot: (
    <>
      ...
      <path d="M2.8 12v3M21.2 12v3" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" />
    </>
  ),
  paw: (
    <>
  ...
  glasses: (
    <>
      <Ring />
      <circle cx="7.3" cy="13" r="3" fill="none" stroke="currentColor" strokeWidth="2.1" />
      <circle cx="16.7" cy="13" r="3" fill="none" stroke="currentColor" strokeWidth="2.1" />
      <path d="M10.3 12.4h3.4M4.3 12.4L3 10M19.7 12.4L21 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </>
  ),
  mobile: (
    <>
  ...
  camera: (
    <>
      ...
      <circle cx="12" cy="13.3" r="3.4" fill="none" stroke="currentColor" strokeWidth="2.1" />
    </>
  ),
  image: (
    <>
  ...
  printer: (
    <>
      ...
      <path d="M7 8.5V4.5h10v4" fill="none" stroke="currentColor" strokeWidth="2" />
